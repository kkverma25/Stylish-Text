...
async def start(c, m):
    ...
    owner_username = owner.username if owner.username else 'JooTech'
...
**✔️ Maintained By:** {owner.mention(style='md')}
"""

    # Buttons
    buttons = [
        [
            InlineKeyboardButton('My Dev ⭐', url=f"https://t.me/{owner_username}")
        ]
    ]
    await m.reply_text(
        text=text,
